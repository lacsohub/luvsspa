document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.nav-links a').forEach(link => {
        ...
        // Check if current path ends with the link href or if it's the index
        if (currentPath.endsWith(linkHref) || (currentPath.endsWith('/luvsspa/') && linkHref.includes('index.html'))) {
